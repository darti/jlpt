...
beforeEach(() => {
  localStorage.clear();
  clearCategoryCache(); clearRappelCache(); clearCoursCache(); // isolate the shared memos from other test files
...
afterEach(() => {
  ...
  clearCategoryCache(); clearRappelCache(); clearCoursCache(); // don't leak our mocked pools into other test files
});
