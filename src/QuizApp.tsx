...
/** Pure, prop-driven quiz-route content — phase-switches the quiz feature driven by
 *  `useQuiz()`. The shell (Header/TopNav/Footer) now lives in AppShell; this returns
 *  only the phase content (AppShell provides the page container). SSR-renderable. */
